  ...
  return (
    ...
    <div className="relative w-full max-w-4xl mx-auto">
      ...
      >
        ...
        >
            {/* 文本输入框 */}
          <div className="px-3 sm:px-4 py-2.5 sm:py-3 min-h-[60px] max-h-[200px] overflow-y-auto">
            <Textarea
              ref={textareaRef}
              value={value}
              ...
              className="w-full min-h-[60px] max-h-[180px] resize-none bg-transparent border-0 outline-none text-gray-800 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 text-sm sm:text-base leading-relaxed focus-visible:ring-0 focus-visible:ring-offset-0"
            />
          </div>
          ...
          <div className="flex items-center justify-between px-2.5 sm:px-3 py-2">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <Button
                ...
                disabled={disabled}
                className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/20"
                title={t('uploadImage')}
              >
            ...
            <Button
              ...
              size="sm"
              className={cn(
                'h-8 px-2 sm:h-9 sm:px-3 rounded-xl transition-all font-medium shadow-sm',
                isTyping
        ...
        {/* 快捷提示 */}
        {files.length === 0 && (
          <div className="px-3 sm:px-4 py-1.5 sm:py-2 text-[10px] sm:text-xs text-muted-foreground bg-muted/50 border-t border-border transition-colors duration-300">
            {t('enterToSend')}
          </div>
        )}
      </div>
