  ...
  return (
    <div className="pb-4 w-full flex justify-center" style={{ maxWidth: DIMENSIONS.SIDEBAR_CONTENT_WIDTH }}>
      {isCollapsed ? (
        ...
        >
          <div className="absolute top-0 right-0 w-4 h-4 bg-border transition-all group-hover:w-full group-hover:h-full group-hover:bg-accent-hover -z-10" />
          <MessageSquarePlus className="w-4 h-4 relative z-10" />
