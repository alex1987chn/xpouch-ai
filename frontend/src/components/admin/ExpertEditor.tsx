        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={cn(
              ...
              previewMode
                ? 'border-[rgb(var(--accent-hover))] bg-[rgb(var(--accent-hover))] text-content-primary'
            ...
            <>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      'hover:bg-[rgb(var(--accent-hover))] hover:text-content-primary hover:border-[rgb(var(--accent-hover))]',
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 py-2 border-2 border-border-default bg-surface-page font-mono text-sm focus:outline-none focus:border-[rgb(var(--accent-hover))] transition-colors resize-y min-h-[80px] bauhaus-scrollbar"
                />
              ...
              <div className="space-y-3">
                ...
                <textarea
                  ...
                  rows={10}
                  className="w-full px-3 py-2 border-2 border-border-default bg-surface-page font-mono text-sm focus:outline-none focus:border-[rgb(var(--accent-hover))] transition-colors resize-y min-h-[150px] bauhaus-scrollbar"
                />
                <div className="flex justify-between font-mono text-[9px] text-content-secondary">
              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full px-3 py-2 border-2 border-border-default bg-surface-page font-mono text-sm focus:outline-none focus:border-[rgb(var(--accent-hover))] transition-colors resize-none"
                  />
                  <div className="flex justify-between font-mono text-[9px] text-content-secondary">
