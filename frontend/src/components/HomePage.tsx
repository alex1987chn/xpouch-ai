...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden bg-transparent">
      {/* Logo + 输入框区域 - 固定在顶部 */}
      <div className="flex-shrink-0 pt-[10vh] pb-6 px-6 md:px-12">
      ...
      {/* Agent Grid Container - 可滚动区域 */}
      <div className="min-h-0 flex-1 overflow-y-auto scrollbar-thin overscroll-behavior-y-contain">
