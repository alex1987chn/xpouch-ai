    ...
    >
      ...
      >
        ...
        <div className="flex gap-0 border-t-2 border-border-default shrink-0">
          <button
            onClick={handleClose}
            className="flex-1 py-3 text-sm font-bold uppercase border-r-2 border-border-default hover:bg-surface-page transition-colors"
          >
            取消
          </button>
          <button
            onClick={handleSave}
            className="flex-1 py-3 bg-accent-hover text-content-primary text-sm font-bold uppercase hover:brightness-95 transition-colors"
          >
