...
export default function CreateAgentPage({ onBack, onSave, initialData, isEditMode = false }: CreateAgentPageProps) {
  ...
  const [selectedModel, setSelectedModel] = useState(initialData?.modelId || 'deepseek-flash')
  ...
  return (
    <div className="flex flex-col h-full bg-transparent">
      ...
      <header
        className={cn(
          "fixed top-0 left-0 right-0 z-40 h-14 px-6 border-b border-border-divider bg-surface-card transition-all duration-200",
      ...
      <div className="flex-1 min-h-0 overflow-hidden pt-14">
        <div className="h-full max-w-7xl mx-auto flex">
          ...
          {/* 右侧：实时预览 */}
          <div className="hidden lg:flex lg:w-[400px] xl:w-[450px] border-l border-border-divider bg-surface-page/50">
