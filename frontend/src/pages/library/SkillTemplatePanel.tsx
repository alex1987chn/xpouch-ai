            ...
            {canEdit && (
              <>
                <button
                  ...
                  className="flex items-center gap-1 border-theme-button border-border-default bg-surface-page px-2 py-1 text-micro font-bold text-content-secondary transition-colors hover:border-border-strong hover:text-content-primary"
            ...
            {filteredTemplates.map((template, index) => (
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  <span className="truncate font-mono text-xs font-bold text-content-primary">
                    {template.name}
                  </span>
                  <span className="shrink-0 text-nano font-mono text-content-muted">
                  ...
                  <div className="mt-2 flex flex-wrap gap-1">
                    {template.expected_artifact_types.map(type => (
                      <span
                        key={type}
                        className={cn(
                          'inline-flex items-center gap-1 px-1.5 py-0.5 text-nano font-mono',
          ...
          <div className="flex items-center gap-2">
            {selectedTemplate && canEdit && (
              <>
                <button
                  onClick={handleShare}
                  className="flex items-center gap-2 border-theme-button border-border-default bg-surface-page px-3 py-1.5 font-mono text-micro font-bold text-content-secondary transition-all hover:border-border-strong hover:text-content-primary"
            ...
            {selectedTemplate && (
              <button
                ...
                className="flex items-center gap-2 border-theme-button border-accent-brand bg-accent-brand px-3 py-1.5 font-mono text-micro font-bold text-accent-ink transition-all hover:brightness-95"
              >
        ...
        <div className="grid gap-4 p-4 md:grid-cols-2">
          ...
          <Field label={t('moduleName') || 'Name'}>
            <input
              ...
              className="w-full border-theme-input border-border-default bg-surface-page px-3 py-2 text-sm text-content-primary outline-none focus:border-border-strong"
            />
          </Field>
          ...
          <Field label={t('templateDescription') || 'Description'} className="md:col-span-2">
            <textarea
              ...
              className="w-full resize-y border-theme-input border-border-default bg-surface-page px-3 py-2 text-sm text-content-primary outline-none focus:border-border-strong"
            />
          </Field>
          ...
          <Field label={t('artifactSchemaHint') || 'Artifact Schema Hint'} className="md:col-span-2">
            <textarea
              ...
              className="w-full resize-y border-theme-input border-border-default bg-surface-page px-3 py-2 text-sm text-content-primary font-mono outline-none focus:border-border-strong"
            />
          </Field>
        </div>
            ...
            <div className="flex items-center gap-2">
              {draft.id && (
                <button
                  ...
                  className="flex items-center gap-2 border-theme-button border-border-default bg-surface-page px-3 py-2 font-mono text-micro font-bold text-content-secondary transition-colors hover:text-accent-destructive"
                >
