...
export type TranslationKey =
  ...
  | 'navDashboard' | 'navExperts' | 'navConsole' | 'systemStatusLockedDesc' | 'userManagementComingSoon' | 'navStats' | 'workspace' | 'navChat' | 'memoryDump' | 'noDataStream'
  // Home
  ...
  | 'version' | 'modelProviders' | 'disabledProviders' | 'administrator' | 'userManagement' | 'themeSoft' | 'themeDark' | 'uuid' | 'userRole' | 'plan' | 'registeredAt'
