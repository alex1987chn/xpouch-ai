...
export const zh = {
  ...
  roleAdmin: '管理员',
  roleUser: '普通用户',
  selfRoleLockedHint: '不能修改自己的角色（防止最后一个管理员自锁）。',
  selfDeleteLockedHint: '不能删除当前登录的账号',
  resetPasswordLabel: '重置密码',
  resetModeRandom: '系统随机',
  resetModeCustom: '自定义密码',
  resetCustomPlaceholder: '输入新密码（≥8 位）',
  resetApply: '重置',
  resetGenerate: '生成随机密码',
  resetModeHint: '随机密码生成后仅显示一次；不通过短信发送，请通过可信渠道交付给用户。',
  resetDeliverHint: '新密码已生成，只显示这一次。请立即复制并通过可信渠道（当面 / 内部通讯）交付给用户。',
  resetPasswordTooShort: '自定义密码至少 8 位',
...
export const en = {
  ...
  searchUsers: 'Search users / phone / email…',
    auditLog: 'Audit Log',
  auditSearch: 'Search actor / action / target…',
  ...
  userNoMatch: 'No matching users',
  selfTag: 'me',
  revealPhone: 'Reveal full phone number',
  maskPhone: 'Mask phone number',
  revealPhoneFailed: 'Failed to get phone number',
  userNameLabel: 'Username',
  emailLabel: 'Email',
  emailPlaceholder: 'Not set',
  phoneLabel: 'Phone',
  userRoleLabel: 'Role',
  roleAdmin: 'Admin',
  roleUser: 'Member',
  selfRoleLockedHint: 'You cannot change your own role (protects the last admin).',
  selfDeleteLockedHint: 'You cannot delete the account you are signed in with',
  resetPasswordLabel: 'Reset password',
  resetModeRandom: 'System random',
  resetModeCustom: 'Custom password',
  resetCustomPlaceholder: 'Enter new password (min 8 chars)',
  resetApply: 'Reset',
  resetGenerate: 'Generate random password',
  resetModeHint: 'The random password is shown only once; it is never sent by SMS. Hand it to the user over a trusted channel.',
  resetDeliverHint: 'New password generated — shown only this once. Copy it now and deliver via a trusted channel (in person / internal chat).',
  resetPasswordTooShort: 'Custom password must be at least 8 characters',
...
export const ja = {
  ...
  searchUsers: 'ユーザー / 電話 / メールを検索…',
    auditLog: '監査ログ',
  auditSearch: '操作者 / アクション / 対象を検索…',
  auditCount: '{count} 件',
  auditEmpty: '監査記録はありません',
  auditColTime: '時刻',
  auditColActor: '操作者',
  auditColAction: 'アクション',
  auditColTarget: '対象',
  ...
  userNoMatch: '該当するユーザーがいません',
  selfTag: '自分',
  revealPhone: '完全な電話番号を表示',
  maskPhone: '電話番号を隠す',
  revealPhoneFailed: '電話番号の取得に失敗しました',
  userNameLabel: 'ユーザー名',
  emailLabel: 'メール',
  emailPlaceholder: '未設定',
  phoneLabel: '電話番号',
  userRoleLabel: 'ユーザーロール',
  roleAdmin: '管理者',
  roleUser: 'メンバー',
  selfRoleLockedHint: '自分のロールは変更できません（最後の管理者の締め出し防止）。',
  selfDeleteLockedHint: '現在ログイン中のアカウントは削除できません',
  resetPasswordLabel: 'パスワードのリセット',
  resetModeRandom: 'システム生成',
  resetModeCustom: 'カスタムパスワード',
  resetCustomPlaceholder: '新しいパスワード（8文字以上）',
  resetApply: 'リセット',
  resetGenerate: 'ランダムパスワードを生成',
  resetModeHint: 'ランダムパスワードは一度だけ表示されます。SMS では送信されないため、信頼できる経路でユーザーへ伝えてください。',
  resetDeliverHint: '新しいパスワードが生成されました。この一度しか表示されないので、今すぐコピーしてユーザーに安全に伝えてください。',
  resetPasswordTooShort: 'パスワードは8文字以上必要です',
  resetPasswordOk: 'パスワードをリセットしました',
  resetPasswordFailed: 'パスワードのリセットに失敗しました',
  userSaved: 'ユーザー情報を保存しました',
  userSaveFailed: '保存に失敗しました',
  userDeleted: 'ユーザーを削除しました',
  userDeleteFailed: '削除に失敗しました',
  userDeleteTitle: 'ユーザーを削除',
