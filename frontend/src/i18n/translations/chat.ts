...
export const zh = {
  ...
  aggregatorExpert: '汇总专家',
  commanderExpert: '编排专家',
  routerExpert: '意图识别专家',
  pending: '等待',
  running: '进行中',
  completed: '完成',
  ...
  expertExpandDesc: '展开完整描述',
  expertCollapseOutput: '收起',
  expertEarlierCalls: '早前 {count} 次调用',
  ...
  artifactTypeText: '文本',
  planApprovedMsg: '计划已批准，将由专家团队协作完成',
...
export const en = {
  ...
  memoryExpert: 'Memory Expert',
  designerExpert: 'Design Expert',
  architectExpert: 'Architecture Expert',
  aggregatorExpert: 'Synthesizer',
  commanderExpert: 'Orchestrator',
  ...
  expertExpandDesc: 'Expand full description',
  expertCollapseOutput: 'Collapse',
  expertEarlierCalls: '{count} earlier calls',
  ...
  planApprovedMsg: 'Plan approved. The expert team will take it from here',
...
export const ja = {
  ...
  memoryExpert: 'メモリーエキスパート',
  designerExpert: 'デザインエキスパート',
  architectExpert: 'アーキテクチャエキスパート',
  aggregatorExpert: '統合エキスパート',
  commanderExpert: 'オーケストレーター',
  ...
  expertExpandDesc: '説明全文を展開',
  expertCollapseOutput: '折りたたむ',
  expertEarlierCalls: '以前の {count} 回の呼び出し',
  ...
  planApprovedMsg: 'プラン承認済み。専門家チームが連携して進めます',
