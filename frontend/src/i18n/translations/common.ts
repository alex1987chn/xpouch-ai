...
export const zh: Record<string, string> = {
  ...
  passwordLoginHint: '手机验证码注册的账号，可在个人设置中开启密码登录',
  passwordSetup: '密码设置',
...
export const en: Record<string, string> = {
  ...
  passwordLoginHint: 'Accounts registered via SMS can enable password login in personal settings',
...
export const ja: Record<string, string> = {
  ...
  passwordLoginHint: 'SMSで登録したアカウントは、個人設定でパスワードログインを有効化できます',
